...
// user-provided entry-point for a Windows-based application
int CALLBACK WinMain(
	_In_     HINSTANCE hInstance,		// zeigt auf aktuelle Instanz der Anwendung
	_In_opt_ HINSTANCE hPrevInstance,	// zeigt auf die vorherige Instanz (immer NULL)
	_In_     LPSTR     lpCmdLine,		// Kommandozeile der Anwendung (ohne Programmname)
	_In_     int       nCmdShow)
{
	// um Warnungen zu unterdruecken
